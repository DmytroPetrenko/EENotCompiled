			...
			<el-col class="header-menu" :span="12">
				...
				>
					<el-menu-item index="1"
						><router-link to="/">{{ $t("menu.home") }}</router-link></el-menu-item
					>
					<el-menu-item index="2"
						><router-link to="/batteries">{{ $t("menu.batteries") }}</router-link></el-menu-item
					>
					<el-menu-item index="3"
						><router-link to="/service">{{ $t("menu.service") }}</router-link></el-menu-item
					>
					<el-menu-item index="4"
						><router-link to="/contact">{{ $t("menu.contact") }}</router-link></el-menu-item
					>
				</el-menu>
				<el-menu
					v-else
